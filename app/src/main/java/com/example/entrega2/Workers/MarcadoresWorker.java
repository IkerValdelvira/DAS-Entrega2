...
// Tarea encargada de conectarse con un servicio web (PHP) para realizar operaciones relacionadas con la tabla 'Marcadores' de la base de datos remota de la aplicación
public class MarcadoresWorker extends Worker {
    ...
    public Result doWork() {
        try {
            ...
            // Se genera un objeto HttpURLConnection para conectarse con el servicio PHP 'marcadores.php' en el servidor
            ...
            // Si la operación es UN MARCADOR DE UN USUARIO
            ...
            // Si la operación es OBTENER LOS MARCADORES DE UN USUARIO
            ...
            // Si la operación es INSERTAR UN NUEVO MARCADOR
