...
public class InsertarMarcadorWorker extends Worker {

    public InsertarMarcadorWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String direccion = "http://ec2-54-167-31-169.compute-1.amazonaws.com/ivaldelvira001/WEB/entrega2/insertarMarcador.php";
