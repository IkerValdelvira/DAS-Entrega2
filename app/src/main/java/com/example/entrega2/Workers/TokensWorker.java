...
// Tarea encargada de conectarse con un servicio web (PHP) para realizar operaciones relacionadas con la tabla 'Tokens' de la base de datos remota de la aplicación
public class TokensWorker extends Worker {

    public TokensWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        try {
            ...
            String direccion = "http://ec2-54-167-31-169.compute-1.amazonaws.com/ivaldelvira001/WEB/entrega2/tokens.php";
            ...
            // Si la operación es OBTENER LOS TOKENS DE UN USUARIO
            if("getTokens".equals(funcion)){
            ...
            // Si la operación es INSERTAR UN NUEVO TOKEN PARA UN USUARIO
            else if("insertarToken".equals(funcion)){
                // Se recupera la información enviada a la tarea
                String username = getInputData().getString("username");
